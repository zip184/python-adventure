...
while True:
    if current_place == "start":
        ...
        while True:
            choice = ask("Choose an action:", ["Explore the forest", "Follow a path", "Climb a tree", "Check wealth"])
            if choice == 0:
        ...
        while True:
            choice = ask("Choose an action:", ["Cross the river", "Follow the river", "Build a raft", "Turn back", "Check wealth"])
            if choice == 0:
                ...
                print("You build a raft, which sinks immediately and you are forced to walk back to the riverbank.")
                current_place = "river"
                experience -= 1
                break
            elif choice == 4:
        ...
        while True:
            choice = ask("Choose an action:", ["Cross the bridge", "Climb down into the ravine", "Turn back", "Check wealth"])
            if choice == 0:
        ...
        while True:
            choice = ask("Choose an action:", ["Explore the cave", "Leave the cave", "Check wealth"])
            if choice == 0:
        ...
        while True:
            choice = ask("Choose an action:", ["Open the chest", "Leave the chest", "Check wealth"])
            if choice == 0:
                print("You open the chest and find a lot of gold. You decide to circle back and explore the cave you saw earlier.")
                current_place = "cave"
                experience += 5
                wealth += 500
                break
        ...
        while True:
            choice = ask("Choose an action:", ["Follow the tunnel", "Leave the tunnel", "Check wealth"])
            if choice == 0:
                print("You follow the tunnel and come across what seems to be a small, rural town.")
                current_place = "town"
                experience += 250
                break
            elif choice == 1:
        ...
        while True:
            choice = ask("Choose an action:", ["Explore the town", "Buy some supplies", "Rest in a dorm", "Leave the town", "Check wealth"])
            if choice == 0:
                print("You explore the town and find a cafeteria. You think to yourself, is this some sort of school?")
                experience += 1
                break
            elif choice == 1:
                print("You buy some food to fill your growling stomach, and store the rest in your pocket.")
                wealth -= 50
                experience += 5
                print("This cost you 50 coins and you currently have", wealth, "coins remaining.")
            elif choice == 2:
